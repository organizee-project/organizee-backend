...
@Configuration
class UseCaseConfig(val guideService: GuideService, val commentService: CommentService) {
    @Bean
    ...
    @Bean
    fun commentUsecase(): CreateCommentUseCase = CreateCommentUseCase(commentService)
}